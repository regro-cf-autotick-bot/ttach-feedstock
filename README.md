...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ttach-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14831&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ttach-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ttach` can be installed with:

```
conda install ttach
```

It is possible to list all of the versions of `ttach` available on your platform with:
